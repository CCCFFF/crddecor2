...
class HomePicturesControllerTest < ActionController::TestCase
  ...
  test "should create home_picture" do
    assert_difference('HomePicture.count') do
      post :create, home_picture: { home_id: @home_picture.home_id, name: @home_picture.name, source: @home_picture.source }
    end
  ...
  test "should update home_picture" do
    patch :update, id: @home_picture, home_picture: { home_id: @home_picture.home_id, name: @home_picture.name, source: @home_picture.source }
    assert_redirected_to home_picture_path(assigns(:home_picture))
  end
