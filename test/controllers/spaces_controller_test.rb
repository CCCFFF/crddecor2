...
class SpacesControllerTest < ActionController::TestCase
  ...
  test "should create space" do
    assert_difference('Space.count') do
      post :create, space: { category: @space.category, home_id: @space.home_id, name: @space.name, size: @space.size }
    end
  ...
  test "should update space" do
    patch :update, id: @space, space: { category: @space.category, home_id: @space.home_id, name: @space.name, size: @space.size }
    assert_redirected_to space_path(assigns(:space))
  end
