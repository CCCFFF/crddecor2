...
class ThoughtsControllerTest < ActionController::TestCase
  ...
  test "should create thought" do
    assert_difference('Thought.count') do
      post :create, thought: { space_picture_id: @thought.space_picture_id, text: @thought.text, user_id: @thought.user_id }
    end
  ...
  test "should update thought" do
    patch :update, id: @thought, thought: { space_picture_id: @thought.space_picture_id, text: @thought.text, user_id: @thought.user_id }
    assert_redirected_to thought_path(assigns(:thought))
  end
